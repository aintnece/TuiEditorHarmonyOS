...
**Last updated**: 2026-06-24 (Phase 8.2e-4 Hard breaks 反斜杠换行+尾随空格剥离完成。基线 exact 69.79% (455/652)，cosmetic 归零，Hard breaks 9→12，全 26 节 0 回归)
...
**（无活动批次）** — Phase 8.2e-4 Hard breaks 完成，8.2e 其余子簇（normalizeURI 百分号编码横切 / 命名实体大表 / inline Raw HTML / HTML blocks / Setext）待选。
