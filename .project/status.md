...
**Last updated**: 2026-06-24 (Phase 8.2e-6 inline Raw HTML 完成。基线 exact 74.39% (485/652)，Raw HTML 6→18，Emphasis 满分 132/132，全 26 节 0 回归)
...
**（无活动批次）** — Phase 8.2e-6 inline Raw HTML 完成，8.2e 其余子簇（命名实体大表 / HTML blocks / Setext / Ex623-624-645）待选。
