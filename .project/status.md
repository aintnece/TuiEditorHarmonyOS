...
**Last updated**: 2026-06-24 (Phase 8.2g ATX headings 完成。基线 exact 87.88% (573/652)，ATX headings 12→18 满分，全 26 节 0 回归)
...
**（无活动批次）** — Phase 8.2g ATX headings 完成（标题满分，+6）。剩余多为列表内容缩进模型 / 深度 Tabs / 引用式边角（Links/Link-ref-def/Images/List items/Lists/Tabs）。
