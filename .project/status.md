...
**Last updated**: 2026-06-24 (Phase 8.2b Emphasis delimiter-run 算法完成。基线 exact 64.57% (421/652)，Emphasis 节 46→129/132，全 26 节 0 回归。下一步 8.2e 零碎节)
...
**（无活动批次）** — Phase 8.2b 完成（Emphasis delimiter-run 算法，最大簇收口），8.2e 零碎节待选。
...
- **8.2e 零碎**（剩余最大杠杆）：Entity refs(13) / inline Raw HTML(14, 含 Emphasis 剩的 Ex475-477) / HTML blocks(24) / Code spans / Hard breaks / Autolinks / Setext 等零碎节，逐节累加。
