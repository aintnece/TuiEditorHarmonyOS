...
**Last updated**: 2026-06-24 (Phase 8.2G1 命名实体表+文本解码 完成。基线 exact 81.75% (533/652)，Entity 13→14，新增 2125 项 HTML5 实体表，全 26 节 0 回归)
...
**（无活动批次）** — Phase 8.2G1 命名实体表+文本解码 完成。实体表已就位，**G-2 待做**：dest/title/info string 上下文实体解码（Ex32/33/34 + 连带 Links/Images/Link-ref-def/Fenced 含实体的双因例，碰 normalizeUri 管线）。
