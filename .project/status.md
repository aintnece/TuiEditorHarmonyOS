...
**Last updated**: 2026-06-24 (Phase 8.2G2 实体解码接入 dest/title/info 完成。基线 exact 82.67% (539/652)，Entity 14→17满分，Links 67→69，Backslash 12→13，全 26 节 0 回归)
...
**（无活动批次）** — Phase 8.2G2 实体解码接入 dest/title/info 完成（命名实体 G-1+G-2 全做完，Entity 满分）。剩余多为缩进/列表纠缠 / Renderer 收尾 / 引用式解析边角 / 深度 Tabs。
