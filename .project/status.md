...
**Last updated**: 2026-06-24 (Phase 8.2e HTML blocks 完成。基线 exact 78.22% (510/652)，HTML blocks 22→43/44，Raw HTML 满分 20/20，全 26 节 0 回归)
...
**（无活动批次）** — Phase 8.2e HTML blocks 完成，8.2e 其余子簇（命名实体大表 / Setext / Ex623-624-645）待选；其余多为块级 Blocks.ts 大功能。
