...
- 三方核对一致（CC / Hermes 亲跑 harness=602 / 全节回归脚本 REGRESSIONS NONE + 净增量自洽 6=6 + 血缘节 Links/Code spans/Images/Paragraphs 全不变）+ ArkTS grep 0 命中（具名 class、字符串/数组下标合法、无正则/匿名字面量/Record/spread/any/对象属性下标）。spec: `.project/8.2j-multiline-linkref-spec.md`。
